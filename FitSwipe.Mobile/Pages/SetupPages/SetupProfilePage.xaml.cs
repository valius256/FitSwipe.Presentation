...
public partial class SetupProfilePage : ContentPage
{
    ...
    public async Task<bool> Validate()
    {
        ...
        else if (UserProfile.Ward == null || UserProfile.City == null || UserProfile.District == null)
        {
            await DisplayAlert("Thiếu thông tin", "Vui lòng cung cấp cả Phường Xã/ Quận Huyện nơi bạn sống để chúng tôi có thể cho bạn những trải nghiệm tốt nhất", "OK");
            return false;
        } 
